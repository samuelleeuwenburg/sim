...
use cpal::{BufferSize as CpalBufferSize, Sample, SampleFormat, StreamConfig};
...
pub fn get_device(
    ...
    let mut supported_configs_range = cpal_device
    ...
    let cpal_stream = match sample_format {
        SampleFormat::F32 => cpal_device.build_output_stream(
            &config,
