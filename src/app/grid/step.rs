...
use screech::{Input, Output, Screech, Signal};
use std::cmp;
...
impl Entity for Step {
    ...
    fn get_display(&self) -> DisplayEntity {
        ...
        let color = match self.state {
            State::Discharging => Color::Rgba(255, 200, 200, alpha),
            _ => Color::Rgba(255, 50, 200, 0.5),
        };
    ...
    fn get_settings(&self) -> Vec<EntitySetting> {
        vec![EntitySetting::new(
            EntitySettingValue::Integer(self.charge),
            "cap",
        )]
    }
